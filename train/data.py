...
class DPOData(object):
    '''
    SFTPV means SupervisedFineTuningPackingVarlenData
    '''
    ...
    def collate_fn(self, records):
        ...
        packed_log_probs = records[0]['packed_log_probs'].to(torch.int32)
        return dict(
            input_ids=input_ids,
            labels=labels,
            attention_mask=attention_mask,
            packed_seq_lens=packed_seq_lens,
            packed_log_probs=packed_log_probs,
